            ...
            <div className="relative flex flex-col m-6 space-y-8 bg-white shadow-2xl rounded-2xl md:flex-row md:space-y-0">
                ...
                <div className="flex flex-col justify-center p-8 md:p-14">
                    ...
                    <div className="flex items-center justify-center space-x-2 my-4">
                        ...
                        <span className="text-gray-400 font-normal">continue with</span>
                        <span className="h-px w-16 bg-gray-300"></span>
                    </div>
                    <div className="flex justify-center gap-4">
                        <button className="p-2 border border-gray-300 rounded-full hover:bg-gray-50"><GoogleIcon /></button>
                        <button className="p-2 border border-gray-300 rounded-full hover:bg-gray-50"><FacebookIcon /></button>
                    </div>
